...
class TestShellDatabase(Shell, DB):
    ...
    def test_version_control_specified(self):
        ...
        # Test database version number (should start at 2)
    ...
    def test_upgrade(self):
        ...
        # Add a script to the repository; upgrade the database
    ...
    def _run_test_sqlfile(self, upgrade_script, downgrade_script):
        # TODO: add test script that checks if database really changed
        repos_path = self.tmp()
        repos_name = 'repos'
    ...
    # being tested (.sql files) ought to work with any database.
    ...
    def test_rundiffs_in_shell(self):
        ...
        # Update database to latest model.
  ...
  ##Column('passwd', String(length=None, convert_unicode=False, assert_unicode=None))""" in result.stdout)
        ...
        ## We're happy with database changes, make first database upgrade script to go from version 0 -> 1.
