...
this explicitly::
    ...
    e = create_engine('sqlite+pysqlite:///file.database', module=sqlite)
...
looks like::
    ...
    # relative path
    e = create_engine('sqlite:///path/to/database.database')
...
used. Double backslashes are probably needed::
    ...
    e = create_engine('sqlite:///C:\\\\path\\\\to\\\\database.database')
...
needed within multiple threads for this case::
    ...
    engine = create_engine('sqlite:///mydb.database',
...
ourselves. This is achieved using two event listeners::
    ...
    engine = create_engine("sqlite:///myfile.database")
    ...
    def create_connect_args(self, url):
        if url.username or url.password or url.host or url.port:
            raise exc.ArgumentError(
                ...
                " sqlite:///relative/path/to/file.database\n"
                " sqlite:////absolute/path/to/file.database" % (url,))
